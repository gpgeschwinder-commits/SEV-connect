...
const BMW8_HIN=[{id:59,t:"05:22"},{id:60,t:"05:25"},{id:61,t:"05:28"},{id:62,t:"05:30"},{id:63,t:"05:32"},{id:64,t:"05:38"},{id:65,t:"05:40"},{id:66,t:"05:46"},{id:67,t:"05:49"},{id:68,t:"06:33"},{id:69,t:"06:34"},{id:70,t:"06:37"},{id:71,t:"06:43"},{id:72,t:"06:44"},{id:73,t:"06:45"}];
const RB6=(p)=>({id:`${p}_rb6`,dep:"08:20",arr:"09:20",label:"RB6 · Starnberg → München Hbf",stops:[{id:102,t:"08:20"},{id:103,t:"09:05"},{id:105,t:"09:20"}]});
const RB65=(p)=>({id:`${p}_rb65`,dep:"10:05",arr:"11:05",label:"RB65 · München Hbf → Starnberg",stops:[{id:105,t:"10:05"},{id:104,t:"10:20"},{id:102,t:"11:05"}]});
...
const VOLD={ziel:"Voldering, 84405 Dorfen",stopId:100};
...
const DIENSTPLAENE={
  "Gerhard Geschwinder":{
    ...
    "2026-06-01":{fahrzeug:"ED-DB 89",dienst:"BMW 8",code:null,dienstbeginn:"05:22",dienstende:"16:40",anfahrt:{ziel:"Reisen",stopId:59},rueckfahrt:null,touren:[
      {id:"GG_0601_1",dep:"05:22",arr:"06:45",label:"BMW Erding 8 — Hinfahrt München",stops:BMW8_HIN},
      {id:"GG_0601_2",dep:"15:35",arr:"16:40",label:"BMW Erding 8 — Rückfahrt München",stops:BMW8_RUECK},
    ]},
    "2026-06-02":{fahrzeug:"ED-DB 89",dienst:"BMW 8",code:null,dienstbeginn:"05:22",dienstende:"16:40",anfahrt:{ziel:"Reisen",stopId:59},rueckfahrt:null,touren:[
      {id:"GG_0602_1",dep:"05:22",arr:"06:45",label:"BMW Erding 8 — Hinfahrt München",stops:BMW8_HIN},
      {id:"GG_0602_2",dep:"15:35",arr:"16:40",label:"BMW Erding 8 — Rückfahrt München",stops:BMW8_RUECK},
    ]},
    "2026-06-03":{fahrzeug:"ED-DB 89",dienst:"BMW 8",code:null,dienstbeginn:"05:22",dienstende:"16:40",anfahrt:{ziel:"Reisen",stopId:59},rueckfahrt:null,touren:[
      {id:"GG_0603_1",dep:"05:22",arr:"06:45",label:"BMW Erding 8 — Hinfahrt München",stops:BMW8_HIN},
      {id:"GG_0603_2",dep:"15:35",arr:"16:40",label:"BMW Erding 8 — Rückfahrt München",stops:BMW8_RUECK},
    ]},
    "2026-06-04":{fahrzeug:"ED-DB 42",dienst:"S2",code:"UEIO94",dienstbeginn:"04:46",dienstende:"15:12",anfahrt:OB(1),rueckfahrt:{ziel:"Betriebshof München Zentrale"},touren:S2AC("GG_0604")},
    "2026-06-05":{fahrzeug:"ED-DB 42",dienst:"S2",code:"POHR28",dienstbeginn:"04:46",dienstende:"13:52",anfahrt:OB(1),rueckfahrt:{ziel:"Betriebshof München Zentrale"},touren:S2AMF("GG_0605")},
    "2026-06-06":FREE(),
    "2026-06-07":{fahrzeug:"ED-DB 42",dienst:"S2",code:"LXEN92",dienstbeginn:"04:46",dienstende:"15:12",anfahrt:OB(1),rueckfahrt:{ziel:"Betriebshof München Zentrale"},touren:S2AC("GG_0607")},
    "2026-06-08":{fahrzeug:"ED-DB 42",dienst:"S2",code:"HEH102",dienstbeginn:"05:16",dienstende:"13:22",anfahrt:OB(1),rueckfahrt:{ziel:"Betriebshof München Zentrale"},touren:S2AMF("GG_0608")},
    "2026-06-09":{fahrzeug:"ED-DB 42",dienst:"S2",code:"WDOC64",dienstbeginn:"05:16",dienstende:"13:22",anfahrt:OB(1),rueckfahrt:{ziel:"Betriebshof München Zentrale"},touren:S2AMF("GG_0609")},
    "2026-06-10":{fahrzeug:"ED-DB 42",dienst:"S2 + FZ Dorfen–Hienraching",code:"YBEL82",dienstbeginn:"05:16",dienstende:"~17:00",anfahrt:OB(1),rueckfahrt:{ziel:"Betriebshof München Zentrale"},touren:[...S2AMF("GG_0610"),{id:"GG_0610_fz",dep:"16:00",arr:"~17:00",label:"FZ Dorfen → Hienraching (Schulbus Förderzentrum)",note:"Bus in Voldering abholen · Umstieg auf DB 300 · Details folgen",stops:[]}]},
    "2026-06-11":{fahrzeug:"ED-DB 42",dienst:"S2 + FZ Dorfen–Hienraching",code:"LFFT55",dienstbeginn:"05:16",dienstende:"~17:00",anfahrt:OB(1),rueckfahrt:{ziel:"Betriebshof München Zentrale"},touren:[...S2AMF("GG_0611"),{id:"GG_0611_fz",dep:"16:00",arr:"~17:00",label:"FZ Dorfen → Hienraching (Schulbus Förderzentrum)",note:"Bus in Voldering abholen · Umstieg auf DB 300 · Details folgen",stops:[]}]},
    "2026-06-12":{fahrzeug:"ED-DB 42",dienst:"S2",code:"IXQP20",dienstbeginn:"05:16",dienstende:"13:22",anfahrt:OB(1),rueckfahrt:{ziel:"Betriebshof München Zentrale"},touren:S2AMF("GG_0612")},
  },
  "Sebastian Deuschel":{
...
function Login({onDriver}){
  ...
  return <div style={{fontFamily:"'Nunito',sans-serif",background:"#0B0F1A",minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:32}}>
    ...
    <div style={{textAlign:"center",marginBottom:48,animation:"fadeUp .5s ease"}}>
      ...
      <div style={{fontSize:12,color:"#555",marginTop:6}}>{today} · v5.0</div>
    </div>
...
function FahrerApp({driver,onLogout}){
  ...
  const[phase,setPhase]=useState("woche");
  ...
  useEffect(()=>{
    ...
    wRef.current=navigator.geolocation.watchPosition(pos=>{
      ...
      if(!gpsOn){setGpsOn(true);setGpsBanner({text:"GPS aktiv · Genauigkeit ±"+Math.round(pos.coords.accuracy)+" m",kind:"ok"});clearTimeout(tRef.current);tRef.current=setTimeout(()=>setGpsBanner(null),4500);}
  ...
  const getKW=dk=>{
    ...
    target.setMonth(0,1); // 1. Januar
    if(target.getDay()!==4){ // erster Donnerstag des Jahres
  ...
  if(phase==="tour"&&activeTour) return <div style={{fontFamily:"'Nunito',sans-serif",background:"#0B0F1A",minHeight:"100vh",color:"#fff",maxWidth:520,margin:"0 auto",display:"flex",flexDirection:"column"}}>
    ...
    {gpsBanner&&(()=>{const bg={ok:"#1a3a2a",gps:"#1a3a2a",warn:"#3a2a1a",check:"#1a2a3a"}[gpsBanner.kind]||"#1a3a2a";const bc={ok:"#2ECC71",gps:"#2ECC71",warn:"#F39C12",check:"#3498DB"}[gpsBanner.kind]||"#2ECC71";const ic={ok:"✓",gps:"📡",warn:"⚠️",check:"⏳"}[gpsBanner.kind]||"✓";const tl={ok:"Halt bestätigt",gps:"GPS — Halt erkannt",warn:"Achtung",check:"Prüfe Standort"}[gpsBanner.kind]||"Halt bestätigt";return <div onClick={()=>{clearTimeout(tRef.current);setGpsBanner(null);}} style={{position:"fixed",top:80,left:"50%",transform:"translateX(-50%)",background:bg,border:"2px solid "+bc,borderRadius:16,padding:"12px 20px",display:"flex",alignItems:"center",gap:10,zIndex:100,animation:"slideUp .3s ease",maxWidth:340,cursor:"pointer"}}><span style={{fontSize:20}}>{ic}</span><div><div style={{fontSize:13,color:bc,fontWeight:800}}>{tl}</div><div style={{fontSize:12,color:"#ddd"}}>{gpsBanner.text}</div></div></div>;})()}
    <LSButton driver={driver?.name}/>
  </div>;
  ...
  // ─── FENSTER A — WOCHENÜBERSICHT ───
  if(phase==="woche") return <div style={{fontFamily:"'Nunito',sans-serif",background:"#0B0F1A",minHeight:"100vh",color:"#fff",maxWidth:520,margin:"0 auto",display:"flex",flexDirection:"column"}}>
    <style>{FONTS}</style>
    <div style={{padding:"18px 20px 14px",borderBottom:"1px solid rgba(255,255,255,.08)"}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
        <div><div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:28,color:"#E8C84A",letterSpacing:3,lineHeight:1}}>{driver.name}</div><div style={{fontSize:13,color:"#888",marginTop:4}}>Wochenübersicht</div></div>
    ...
    <div style={{flex:1,overflowY:"auto",padding:"16px 20px 100px"}}>
      {Object.entries(fGroups).map(([kw,dks])=><div key={kw} style={{marginBottom:14}}><div style={{fontSize:12,color:"#E8C84A",textTransform:"uppercase",letterSpacing:2,marginBottom:8}}>{kw}</div>{dks.map(dk=><DayCard key={dk} dk={dk}/>)}</div>)}
      {Object.keys(pGroups).length>0&&<div style={{marginTop:8}}>
        <button onClick={()=>setShowArchiv(!showArchiv)} style={{width:"100%",padding:"12px 16px",borderRadius:12,background:"rgba(255,255,255,.03)",border:"1px solid rgba(255,255,255,.08)",color:"#666",fontFamily:"'Nunito',sans-serif",fontWeight:700,fontSize:13,cursor:"pointer",display:"flex",alignItems:"center",gap:8}}>📂 Archiv — vergangene Tage <span style={{marginLeft:"auto"}}>{showArchiv?"▲":"▼"}</span></button>
  ...
  return <div style={{fontFamily:"'Nunito',sans-serif",background:"#0B0F1A",minHeight:"100vh",color:"#fff",maxWidth:520,margin:"0 auto",display:"flex",flexDirection:"column"}}>
    ...
    <div style={{padding:"14px 20px 12px",borderBottom:"1px solid rgba(255,255,255,.08)"}}>
      <button onClick={()=>setPhase("woche")} style={{background:"transparent",border:"none",color:"#C0CAD8",fontSize:14,fontWeight:800,cursor:"pointer",fontFamily:"'Nunito',sans-serif",padding:0,marginBottom:10}}>← Wochenübersicht</button>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
        <div><div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:24,color:dayIsToday?"#2ECC71":dayIsPast?"#E74C3C":"#E8C84A",letterSpacing:2,lineHeight:1.1}}>{new Date(activeDayKey+"T12:00:00").toLocaleDateString("de-DE",{weekday:"long",day:"2-digit",month:"2-digit"})}</div><div style={{fontSize:13,color:"#888",marginTop:3}}>{plan?.fahrzeug||driver.bus} · {plan?.dienst||"—"}{plan?.code?` · ${plan.code}`:""}</div></div>
        <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:24,color:"#E8C84A",letterSpacing:3}}>{time.toLocaleTimeString("de-DE",{hour:"2-digit",minute:"2-digit"})}</div>
      </div>
    </div>
    {!dayIsToday&&plan?.dienst!=="FREI"&&<div style={{background:"rgba(255,255,255,.04)",borderBottom:"1px solid rgba(255,255,255,.08)",padding:"10px 20px",fontSize:12,color:"#888",fontWeight:700,textAlign:"center"}}>🔒 {dayIsPast?"Vergangener Tag":"Zukünftiger Tag"} — nur lesbar</div>}
    <div style={{flex:1,overflowY:"auto",padding:"14px 20px 100px",position:"relative"}}>
      {plan?.dienst==="FREI"&&<div style={{textAlign:"center",padding:"60px 0",color:"#555",fontSize:20}}>🎉 Dienstfrei</div>}
    ...
    {gpsBanner&&(()=>{const bg={ok:"#1a3a2a",gps:"#1a3a2a",warn:"#3a2a1a",check:"#1a2a3a"}[gpsBanner.kind]||"#1a3a2a";const bc={ok:"#2ECC71",gps:"#2ECC71",warn:"#F39C12",check:"#3498DB"}[gpsBanner.kind]||"#2ECC71";const ic={ok:"✓",gps:"📡",warn:"⚠️",check:"⏳"}[gpsBanner.kind]||"✓";const tl={ok:"Halt bestätigt",gps:"GPS — Angekommen",warn:"Achtung",check:"Prüfe Standort"}[gpsBanner.kind]||"Bestätigt";return <div onClick={()=>{clearTimeout(tRef.current);setGpsBanner(null);}} style={{position:"fixed",top:80,left:"50%",transform:"translateX(-50%)",background:bg,border:"2px solid "+bc,borderRadius:16,padding:"12px 20px",display:"flex",alignItems:"center",gap:10,zIndex:100,animation:"slideUp .3s ease",maxWidth:340,cursor:"pointer"}}><span style={{fontSize:20}}>{ic}</span><div><div style={{fontSize:13,color:bc,fontWeight:800}}>{tl}</div><div style={{fontSize:12,color:"#ddd"}}>{gpsBanner.text}</div></div></div>;})()}
    <LSButton driver={driver?.name}/>
  </div>;
}
